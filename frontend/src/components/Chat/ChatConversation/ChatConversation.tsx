        ...
        switch (status) {
            ...
            case StatusType.FINALISED:
                return isRequester
                    ...
                    : [
                          {
                              label: "Merci pour votre contribution. En attente d'évaluation.",
                              onClick: () => {},
                              type: "text",
                          },
                      ];
            case StatusType.ISREVIEWED:
                return isRequester
                    ...
                    : [
                          {
                              label: "Vous avez reçu une nouvelle évaluation. Merci pour votre contribution.",
                              onClick: () => {},
                              type: "text",
                          },
                      ];
        ...
        >
            ...
            {otherUser && otherUser.createdAt && (
                <ChatConversationHeader
                    userRegistrationDate={otherUser.createdAt}
                />
            )}
            ...
            {isHelpRefused ? (
                ...
                >
                    ...
                    >
                        L'aide a été refusée. Vous ne pouvez plus envoyer de
                        messages.
                    </Typography>
                </Box>
            ) : (
            ...
            >
                ...
                >
                    <form
                        onSubmit={handleFormReviewSubmit(onReviewFormSubmitted)}
                    >
                        <Box
                            component="fieldset"
